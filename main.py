...
popi_public_key = config["AOPI"]["popi_public_key"]
...
Exit codes:
    ...
    List:
        ...
        26: The 'installed modules' directory is not a directory
""")
        ...
        match package_to_operate:
            ...
            case "modules":
                ...
                if p(installed_modules).is_dir():
                    ...
                    error("The 'installed modules' is not a directory :(", 25)
                modules_installed = []
                for package in p(installed_modules).iterdir():
                    if package.is_dir():
                        modules_installed.append(package)
                    else:
                        warn(f"The package '{package}' is not a directory")
                print("-" * 30)
                print("[::] Modules found:")
                for i, package in enumerate(modules_installed):
